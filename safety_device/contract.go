...
*/
func (t *ContractChaincode) getEventId(stub shim.ChaincodeStubInterface) (int, error) {
...
*/
func (t *ContractChaincode) updateEventId(stub shim.ChaincodeStubInterface, key int) ([]byte, error)  {
